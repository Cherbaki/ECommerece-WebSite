...
namespace RealShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : Microsoft.AspNetCore.Mvc.RazorPages.PageModel
    {
        ...
        public RegisterModel(
            ...
            IWebHostEnvironment webHostEnvironmant,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Name = Input.ImageFile.FileName,
                        ImageUrl = GetImageUrl("Images/", Input.ImageFile),
                        UserId = user.Id,
                        ProductId = null,
                        CategoryId = null,
                    ...
                    await _dbContext.Image.AddAsync(user.ProfileImage);
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"<a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Click here</a> to confirm your account.");
